...
#from train_permodel import Model
                ...
                for i, img in zip(pbar, train_loader):
                    ...
                    if epoch % 50 == 0 and i == total_samples//args.batch_size-25:
                        with torch.no_grad():
                            ...
                            vutils.save_image(real_fake_images, os.path.join("/scratch/moravapa/images", f"image_freeze1{epoch}.jpg"), nrow=4)
                            #torch.save(checkpoints,os.path.join("/scratch/moravapa/chkpt", f"perc1_{epoch}.ckpt"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=251, help='Number of epochs to train (default: 50)')
    ...
    parser.add_argument('--model', type=str, default='train_perceptual(freeze1)', help='For saving the log for each model')
